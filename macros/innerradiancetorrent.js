...
if (targetTokens.length != 0) { 
    let sequence = new Sequence({moduleName: "PF2e Animations", softFail: true})
        .sound()
            .volume(0.7)
            .file("sound/NWN2-Sounds/sdr_mindhit.WAV")
            .fadeInAudio(50)
            .fadeOutAudio(750)
            .endTime(1500)
        .effect()
            .file("jb2a.sphere_of_annihilation.200px.purple")
            .atLocation(tokenD)
            .scale(1) 
        ...
        .sound()
            .volume(0.7)
            .file("sound/NWN2-Sounds/sfx_MagicalImplosion1.WAV")
        .sound()
            .volume(0.7)
            .file("sound/NWN2-Sounds/sim_rayodd.WAV")
            .fadeOutAudio(500)
    for (let i = 0; i < 8; i++) {
        sequence
            .effect()
                .file([Sequencer.Helpers.random_array_element(colouredBolts, false)])
                .atLocation(tokenD) 
            ...
            .sound()
                .volume(0.3)
                .file("sound/NWN2-Sounds/sfx_MagicalImplosion2.WAV")
                .fadeInAudio(50)
                .fadeOutAudio(50)
